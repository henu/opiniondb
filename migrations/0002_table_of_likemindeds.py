...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeMinded'
        db.create_table(u'opiniondb_likeminded', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('likeminded', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('priority', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'opiniondb', ['LikeMinded'])


    def backwards(self, orm):
        # Deleting model 'LikeMinded'
        db.delete_table(u'opiniondb_likeminded')
